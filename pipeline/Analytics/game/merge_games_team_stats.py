...
def merge_games_team_stats(raw_parse_game, raw_parse_game_stats): 
    ...
    df_games_int_home = df_games.merge(
        df_games_stats, 
        left_on = ["game_id", "home_id", "home_team"],
        right_on = ["game_id", "team_id", "team"],
        how = "left"
    )
    ...
    df_games_int_away = df_games.merge(
        df_games_stats, 
        left_on = ["game_id", "away_id", "away_team"],
        right_on = ["game_id", "team_id", "team"],
        how = "left"
    )
    ...
    with open("data/raw/derived/merge_games_team_stats_sample.json", "w")as jsonmerge_games_team_stats : 
